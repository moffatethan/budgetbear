      ...
      <div className="py-2 text-center">
        <form onSubmit={handleSubmit(onSubmit)} className="bg-white w-6/12 m-auto rounded-lg shadow- text-left">
          ...
          <div className="grid grid-cols-2 gap-4 px-7 pt-4 pb-5">
            ...
            <div className="form-group">
              <label className={`block mb-2 uppercase text-sm tracking-wide font-medium ${errors.lastName ? 'text-red-500' : 'text-gray-500'}`}>due date</label>
              ...
              {errors.dueDate && <span className="text-red-500 font-medium my-2 block text-sm">Due date is required</span>}
            </div>
          </div>
